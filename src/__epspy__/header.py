...
# (Line 16) const Devourer 	= 62;
Devourer = _CGFW(lambda: [62], 1)[0]
...
# (Line 23) const List = [66, 83, 96, 63, 62, 5, 3, 2, 103, 39];
List = _CGFW(lambda: [_ARR(FlattenList([66, 83, 96, 63, 62, 5, 3, 2, 103, 39]))], 1)[0]
