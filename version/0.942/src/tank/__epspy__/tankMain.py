...
def f_controlTank(targetPlayer):
    ...
    if EUDElseIf()(EUDSCAnd()(4 == keyValue)(Switch(targetPlayer, Cleared))()):
        ...
        # (Line 86) SetDeaths(targetPlayer, SetTo, 0, header.jKeyDelay);
        DoActions(SetDeaths(targetPlayer, SetTo, 0, header.jKeyDelay))
        # (Line 87) }
    ...
    if EUDElseIf()(EUDSCAnd()(4 == keyValue, neg=True)(Switch(targetPlayer, Set))()):
        ...
        # (Line 90) SetDeaths(targetPlayer, Add, 1, header.jKeyDelay);
        DoActions(SetDeaths(targetPlayer, Add, 1, header.jKeyDelay))
        # (Line 91) }
    ...
    if EUDElseIf()(EUDSCAnd()(4 == keyValue)(Switch(targetPlayer, Set))()):
        ...
        # (Line 96) SetDeaths(targetPlayer, SetTo, 0, header.jKeyDelay);
        DoActions(SetDeaths(targetPlayer, SetTo, 0, header.jKeyDelay))
        # (Line 97) }
    ...
    if EUDElseIf()(EUDSCAnd()(8 == keyValue)(Switch(targetPlayer + 6, Cleared))()):
        ...
        # (Line 106) SetDeaths(targetPlayer, SetTo, 6, header.lKeyDelay);
        DoActions(SetDeaths(targetPlayer, SetTo, 6, header.lKeyDelay))
    ...
    if EUDIf()(EUDSCAnd()(8 == keyValue, neg=True)(Switch(targetPlayer + 6, Set))()):
        ...
        # (Line 112) SetDeaths(targetPlayer, Subtract, 1, header.lKeyDelay);
        DoActions(SetDeaths(targetPlayer, Subtract, 1, header.lKeyDelay))
        # (Line 114) }
    ...
    if EUDElseIf()(EUDSCAnd()(8 == keyValue)(Switch(targetPlayer + 6, Set))()):
        ...
        # (Line 117) SetDeaths(targetPlayer, SetTo, 6, header.lKeyDelay);
        DoActions(SetDeaths(targetPlayer, SetTo, 6, header.lKeyDelay))
        # (Line 118) }
        # (Line 120) if(Deaths(targetPlayer, Exactly, 0, header.lKeyDelay) && Switch(targetPlayer+6, Set))
    EUDEndIf()
    if EUDIf()(EUDSCAnd()(Deaths(targetPlayer, Exactly, 0, header.lKeyDelay))(Switch(targetPlayer + 6, Set))()):
        # (Line 121) {// change weapon keydelay
        # (Line 122) SetSwitch(targetPlayer+6, Clear);
        DoActions(SetSwitch(targetPlayer + 6, Clear))
        # (Line 123) }
        # (Line 124) if (Deaths(targetPlayer, AtLeast, 8, header.jKeyDelay) || power == 0)
    EUDEndIf()
    if EUDIf()(EUDSCOr()(Deaths(targetPlayer, AtLeast, 8, header.jKeyDelay))(power == 0)()):
        # (Line 125) {// shoot key delay
        # (Line 126) utilEud.setRemainingBuildtime(unitEpd, header.maxbuildtime);
        utilEud.f_setRemainingBuildtime(unitEpd, header.maxbuildtime)
        # (Line 127) SetDeaths(targetPlayer, SetTo, 0, header.jKeyDelay);
        DoActions(SetDeaths(targetPlayer, SetTo, 0, header.jKeyDelay))
